    ...
    private void guidesButton() {
        ...
        guides.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentGuides = new Intent(Home2Activity.this, Guides2Activity.class);
                startActivity(intentGuides);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (requestCode == 1 && resultCode == RESULT_OK
                ...
                cursor.close();
                Intent i = new Intent(Home2Activity.this , ScaleVideo.class);
